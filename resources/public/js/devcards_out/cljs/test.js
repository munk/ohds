...
var args27335 = [];
var len__20629__auto___27339 = arguments.length;
var i__20630__auto___27340 = (0);
while(true){
if((i__20630__auto___27340 < len__20629__auto___27339)){
args27335.push((arguments[i__20630__auto___27340]));

var G__27341 = (i__20630__auto___27340 + (1));
i__20630__auto___27340 = G__27341;
continue;
} else {
}
break;
...
var G__27338 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
var G__27338__$1 = ((cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter))?cljs.core.assoc.call(null,G__27338,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint):G__27338);
return G__27338__$1;
});
...
var or__19570__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__20629__auto___27346 = arguments.length;
var i__20630__auto___27347 = (0);
while(true){
if((i__20630__auto___27347 < len__20629__auto___27346)){
args__20636__auto__.push((arguments[i__20630__auto___27347]));

var G__27348 = (i__20630__auto___27347 + (1));
i__20630__auto___27347 = G__27348;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__20637__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq27343){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__27344,G__27345,seq27343__$2);
});
...
var line = cljs.core.get.call(null,map__27352__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__27352__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__27352,map__27352__$1,file,line,column){
return (function (p1__27349_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__27349_SHARP_));
});})(map__27352,map__27352__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__20484__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__20484__auto__,prefer_table__20485__auto__,method_cache__20486__auto__,cached_hierarchy__20487__auto__,hierarchy__20488__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__19570__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__19570__auto__)){
return or__19570__auto__;
} else {
...
var temp__4425__auto___27354 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4425__auto___27354)){
var message_27355 = temp__4425__auto___27354;
cljs.core.println.call(null,message_27355);
} else {
}
...
var temp__4425__auto___27356 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4425__auto___27356)){
var message_27357 = temp__4425__auto___27356;
cljs.core.println.call(null,message_27357);
} else {
}
...
var temp__4423__auto__ = (function (){var and__19558__auto__ = typeof exception.stack === 'string';
if(and__19558__auto__){
var G__27363 = exception.stack;
var G__27363__$1 = (((G__27363 == null))?null:clojure.string.split_lines.call(null,G__27363));
var G__27363__$2 = (((G__27363__$1 == null))?null:cljs.core.get.call(null,G__27363__$1,depth));
var G__27363__$3 = (((G__27363__$2 == null))?null:clojure.string.trim.call(null,G__27363__$2));
return G__27363__$3;
} else {
...
var vec__27364 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__27364,(0),null);
var column = cljs.core.nth.call(null,vec__27364,(1),null);
var vec__27365 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__27365,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__27365,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__27365,(2),null);
...
var m__$1 = (function (){var G__27367 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__27367) {
case "fail":
...
var G__27373 = (function (){var G__27372 = cljs.core.rest.call(null,fns);
var G__27372__$1 = (cljs.core.truth_(new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,obj)))?cljs.core.concat.call(null,obj,G__27372):G__27372);
return G__27372__$1;
})();
fns = G__27373;
continue;
...
var G__27375 = fns;
var G__27375__$1 = (((G__27375 == null))?null:cljs.core.vary_meta.call(null,G__27375,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true));
return G__27375__$1;
});
...
}catch (e27378){var e = e27378;
var G__27379 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__27379) {
...
var vec__27382 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__27382,(0),null);
var types = vec__27382;
...
var ns = cljs.core.nth.call(null,vec__27391,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__27391,(1),null);
return ((function (vec__27391,ns,vars__$1){
return (function (){
...
var G__27392 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__27392) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__27392,env,once_fixtures,each_fixtures,vec__27391,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__27392,env,once_fixtures,each_fixtures,vec__27391,ns,vars__$1){
return (function (){
var seq__27393 = cljs.core.seq.call(null,vars__$1);
var chunk__27394 = null;
var count__27395 = (0);
var i__27396 = (0);
while(true){
if((i__27396 < count__27395)){
var v = cljs.core._nth.call(null,chunk__27394,i__27396);
var temp__4425__auto___27398 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4425__auto___27398)){
var t_27399 = temp__4425__auto___27398;
each_fixture_fn.call(null,((function (seq__27393,chunk__27394,count__27395,i__27396,t_27399,temp__4425__auto___27398,v,each_fixture_fn,G__27392,env,once_fixtures,each_fixtures,vec__27391,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_27399)));
});})(seq__27393,chunk__27394,count__27395,i__27396,t_27399,temp__4425__auto___27398,v,each_fixture_fn,G__27392,env,once_fixtures,each_fixtures,vec__27391,ns,vars__$1))
);
} else {
}

var G__27400 = seq__27393;
var G__27401 = chunk__27394;
var G__27402 = count__27395;
var G__27403 = (i__27396 + (1));
seq__27393 = G__27400;
chunk__27394 = G__27401;
count__27395 = G__27402;
i__27396 = G__27403;
continue;
} else {
var temp__4425__auto__ = cljs.core.seq.call(null,seq__27393);
if(temp__4425__auto__){
var seq__27393__$1 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__27393__$1)){
var c__20373__auto__ = cljs.core.chunk_first.call(null,seq__27393__$1);
var G__27404 = cljs.core.chunk_rest.call(null,seq__27393__$1);
var G__27405 = c__20373__auto__;
var G__27406 = cljs.core.count.call(null,c__20373__auto__);
var G__27407 = (0);
seq__27393 = G__27404;
chunk__27394 = G__27405;
count__27395 = G__27406;
i__27396 = G__27407;
continue;
} else {
var v = cljs.core.first.call(null,seq__27393__$1);
var temp__4425__auto___27408__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4425__auto___27408__$1)){
var t_27409 = temp__4425__auto___27408__$1;
each_fixture_fn.call(null,((function (seq__27393,chunk__27394,count__27395,i__27396,t_27409,temp__4425__auto___27408__$1,v,seq__27393__$1,temp__4425__auto__,each_fixture_fn,G__27392,env,once_fixtures,each_fixtures,vec__27391,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_27409)));
});})(seq__27393,chunk__27394,count__27395,i__27396,t_27409,temp__4425__auto___27408__$1,v,seq__27393__$1,temp__4425__auto__,each_fixture_fn,G__27392,env,once_fixtures,each_fixtures,vec__27391,ns,vars__$1))
);
} else {
}

var G__27410 = cljs.core.next.call(null,seq__27393__$1);
var G__27411 = null;
var G__27412 = (0);
var G__27413 = (0);
seq__27393 = G__27410;
chunk__27394 = G__27411;
count__27395 = G__27412;
i__27396 = G__27413;
continue;
}
} else {
...
});})(each_fixture_fn,G__27392,env,once_fixtures,each_fixtures,vec__27391,ns,vars__$1))
);
});})(each_fixture_fn,G__27392,env,once_fixtures,each_fixtures,vec__27391,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1447608114773