...
var x__20225__auto__ = (((x == null))?null:x);
var m__20226__auto__ = (sablono.util.to_str[goog.typeOf(x__20225__auto__)]);
if(!((m__20226__auto__ == null))){
return m__20226__auto__.call(null,x);
} else {
var m__20226__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__20226__auto____$1 == null))){
return m__20226__auto____$1.call(null,x);
} else {
...
var x__20225__auto__ = (((x == null))?null:x);
var m__20226__auto__ = (sablono.util.to_uri[goog.typeOf(x__20225__auto__)]);
if(!((m__20226__auto__ == null))){
return m__20226__auto__.call(null,x);
} else {
var m__20226__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__20226__auto____$1 == null))){
return m__20226__auto____$1.call(null,x);
} else {
...
var len__20629__auto___20793 = arguments.length;
var i__20630__auto___20794 = (0);
while(true){
if((i__20630__auto___20794 < len__20629__auto___20793)){
args__20636__auto__.push((arguments[i__20630__auto___20794]));

var G__20795 = (i__20630__auto___20794 + (1));
i__20630__auto___20794 = G__20795;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__20637__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq20792){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq20792));
});
/**
...
var vec__20797 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__20797,(0),null);
var words = cljs.core.nthnext.call(null,vec__20797,(1));
...
var G__20799 = clojure.set.rename_keys.call(null,m,kmap);
var G__20799__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__20799,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__20799);
return G__20799__$1;
} else {
return m;
}
...
var args__20636__auto__ = [];
var len__20629__auto___20802 = arguments.length;
var i__20630__auto___20803 = (0);
while(true){
if((i__20630__auto___20803 < len__20629__auto___20802)){
args__20636__auto__.push((arguments[i__20630__auto___20803]));

var G__20804 = (i__20630__auto___20803 + (1));
i__20630__auto___20803 = G__20804;
continue;
} else {
}
break;
...
var argseq__20637__auto__ = ((((0) < args__20636__auto__.length))?(new cljs.core.IndexedSeq(args__20636__auto__.slice((0)),(0))):null);
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__20637__auto__);
});

sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic = (function (maps){
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__20800_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__20800_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__20800_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__20800_SHARP_)){
return p1__20800_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__20800_SHARP_], null);
...
sablono.util.merge_with_class.cljs$lang$applyTo = (function (seq20801){
return sablono.util.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq20801));
});
/**
...
var tag_name = cljs.core.nth.call(null,vec__20808,(0),null);
var names = cljs.core.nth.call(null,vec__20808,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__20808,tag_name,names){
return (function (p1__20805_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__20805_SHARP_));
});})(matches,vec__20808,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__20808,tag_name,names){
return (function (p1__20806_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__20806_SHARP_));
});})(matches,vec__20808,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.util.normalize_element = (function sablono$util$normalize_element(p__20809){
var vec__20812 = p__20809;
var tag = cljs.core.nth.call(null,vec__20812,(0),null);
var content = cljs.core.nthnext.call(null,vec__20812,(1));
...
var vec__20813 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__20813,(0),null);
var id = cljs.core.nth.call(null,vec__20813,(1),null);
var class$ = cljs.core.nth.call(null,vec__20813,(2),null);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__19570__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1447608108704