...
weasel.repl.process_message = (function (){var method_table__26003__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"weasel.repl","process-message"),new cljs.core.Keyword(null,"op","op",-1882987955),new cljs.core.Keyword(null,"default","default",-1987822328),hierarchy__26007__auto__,method_table__26003__auto__,prefer_table__26004__auto__,method_cache__26005__auto__,cached_hierarchy__26006__auto__));
})();
...
while (G__33017__i < G__33017__a.length) {G__33017__a[G__33017__i] = arguments[G__33017__i + 0]; ++G__33017__i;}
  args = new cljs.core.IndexedSeq(G__33017__a,0);
} 
return weasel$repl$repl_print__delegate.call(this,args);};
weasel$repl$repl_print.cljs$lang$maxFixedArity = 0;
weasel$repl$repl_print.cljs$lang$applyTo = (function (arglist__33018){
var args = cljs.core.seq(arglist__33018);
...
while (G__33019__i < G__33019__a.length) {G__33019__a[G__33019__i] = arguments[G__33019__i + 0]; ++G__33019__i;}
  args = new cljs.core.IndexedSeq(G__33019__a,0);
} 
return weasel$repl$console_print__delegate.call(this,args);};
weasel$repl$console_print.cljs$lang$maxFixedArity = 0;
weasel$repl$console_print.cljs$lang$applyTo = (function (arglist__33020){
...
var weasel$repl$connect__delegate = function (repl_server_url,p__33024){
...
var print = cljs.core.get.call(null,map__33027__$1,new cljs.core.Keyword(null,"print","print",1299562414),new cljs.core.Keyword(null,"repl","repl",-35398667));
var on_close = cljs.core.get.call(null,map__33027__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var on_error = cljs.core.get.call(null,map__33027__$1,new cljs.core.Keyword(null,"on-error","on-error",1728533530));
var on_open = cljs.core.get.call(null,map__33027__$1,new cljs.core.Keyword(null,"on-open","on-open",-1391088163));
var verbose = cljs.core.get.call(null,map__33027__$1,new cljs.core.Keyword(null,"verbose","verbose",1694226060),true);
var repl_connection = weasel.impls.websocket.websocket_connection.call(null);
cljs.core.swap_BANG_.call(null,weasel.repl.ws_connection,cljs.core.constantly.call(null,repl_connection));

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (repl_connection,map__33027,map__33027__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
...
});})(repl_connection,map__33027,map__33027__$1,print,on_close,on_error,on_open,verbose))
);

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"message","message",-406056002),((function (repl_connection,map__33027,map__33027__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
var map__33028 = cljs.reader.read_string.call(null,evt.message);
var map__33028__$1 = ((cljs.core.seq_QMARK_.call(null,map__33028))?cljs.core.apply.call(null,cljs.core.hash_map,map__33028):map__33028);
var message = map__33028__$1;
var op = cljs.core.get.call(null,map__33028__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
var response = cljs.core.pr_str.call(null,weasel.repl.process_message.call(null,message));
return clojure.browser.net.transmit.call(null,repl_connection,response);
});})(repl_connection,map__33027,map__33027__$1,print,on_close,on_error,on_open,verbose))
);

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (repl_connection,map__33027,map__33027__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
...
clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"error","error",-978969032),((function (repl_connection,map__33027,map__33027__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
if(cljs.core.truth_(verbose)){
...
return cljs.core.into.call(null,cljs.core.PersistentHashSet.EMPTY,cljs.core.filter.call(null,((function (gntp,repl_connection,map__33027,map__33027__$1,print,on_close,on_error,on_open,verbose){
return (function (name){
return (goog.dependencies_.visited[(gntp[name])]);
});})(gntp,repl_connection,map__33027,map__33027__$1,print,on_close,on_error,on_open,verbose))
,cljs.core.js_keys.call(null,gntp)));
})();

goog.isProvided_ = ((function (repl_connection,map__33027,map__33027__$1,print,on_close,on_error,on_open,verbose){
return (function (_){
return false;
});})(repl_connection,map__33027,map__33027__$1,print,on_close,on_error,on_open,verbose))
;

goog.require = ((function (repl_connection,map__33027,map__33027__$1,print,on_close,on_error,on_open,verbose){
...
var G__33029__i = 0, G__33029__a = new Array(arguments.length -  1);
while (G__33029__i < G__33029__a.length) {G__33029__a[G__33029__i] = arguments[G__33029__i + 1]; ++G__33029__i;}
  p__33024 = new cljs.core.IndexedSeq(G__33029__a,0);
} 
return weasel$repl$connect__delegate.call(this,repl_server_url,p__33024);};
weasel$repl$connect.cljs$lang$maxFixedArity = 1;
weasel$repl$connect.cljs$lang$applyTo = (function (arglist__33030){
var repl_server_url = cljs.core.first(arglist__33030);
var p__33024 = cljs.core.rest(arglist__33030);
return weasel$repl$connect__delegate(repl_server_url,p__33024);
});
...
//# sourceMappingURL=repl.js.map?rel=1446160950281