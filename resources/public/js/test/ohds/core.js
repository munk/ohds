...
if(typeof ohds.core.app_state !== 'undefined'){
} else {
...
return cljs.core.println.call(null,"Logging in",username,password);
});
ohds.core.atom_input = (function ohds$core$atom_input(value,id){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref.call(null,value),new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"class","class",-2030961996),"form-control",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__14882_SHARP_){
return cljs.core.reset_BANG_.call(null,value,p1__14882_SHARP_.target.value);
})], null)], null);
});
ohds.core.atom_input_password = (function ohds$core$atom_input_password(value,id){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"type","type",1174270348),"password",new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref.call(null,value),new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"class","class",-2030961996),"form-control",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__14883_SHARP_){
return cljs.core.reset_BANG_.call(null,value,p1__14883_SHARP_.target.value);
})], null)], null);
});
